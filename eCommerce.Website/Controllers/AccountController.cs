...
using eCommerce.Website.App_Start;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string content = System.IO.File.ReadAllText(Server.MapPath("~/Assets/Client/js/template/newuser.html"));
                content = content.Replace("{{UserName}}", adminUser.UserName);
                content = content.Replace("{{Link}}", "https://localhost:44304/" + "dang-nhap.html");
